...
public class BoxJpaEntity {
    ...
    public BoxJpaEntity(UUID id, String txRef, double weightLimitGrams, double weight, double batteryLevel,
                        BoxStateJpa state, Instant createdAt, UUID createdBy) {
        this.id = id;
        this.txRef = txRef;
        this.weightLimit = weightLimitGrams;
        this.totalItemsWeight = weight;
